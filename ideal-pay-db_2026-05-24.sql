...
CREATE TABLE `emp_np` (
  ...
  `is_processed` char(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
  `processed_date` datetime DEFAULT NULL,
  `created_by` bigint NOT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_by` bigint NOT NULL,
...
INSERT INTO `emp_ot` VALUES (-1,-1,-1,0.00,0.00,NULL,'N',NULL,-1,'2026-05-24 04:06:37',-1,'2026-05-24 04:06:37');
...
-- Dump completed on 2026-05-24  9:46:25
