...
CREATE TABLE `emp_bonus` (
  ...
  CONSTRAINT `chk_emp_bonus_processed` CHECK ((`is_processed` in (_utf8mb4'Y',_utf8mb4'N')))
...
INSERT INTO `emp_bonus` VALUES (-1,-1,'MMYYYY',0.00,'N',NULL,-1,'2026-05-17 07:04:46',-1,'2026-05-17 07:04:46'),(1,1,'2026-01',50000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(2,2,'2026-01',30000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(3,3,'2026-01',20000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(4,4,'2026-01',45000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(5,5,'2026-01',15000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(6,6,'2026-02',60000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(7,7,'2026-02',25000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(8,8,'2026-02',35000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(9,9,'2026-02',18000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(10,10,'2026-02',40000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02');
...
CREATE TABLE `emp_loan` (
  ...
  CONSTRAINT `chk_emp_loan_processed` CHECK ((`is_processed` in (_utf8mb4'Y',_utf8mb4'N')))
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `emp_loan` WRITE;
/*!40000 ALTER TABLE `emp_loan` DISABLE KEYS */;
INSERT INTO `emp_loan` VALUES (-1,-1,-1,'MMYYYY',0.00,'N',NULL,-1,'2026-05-17 07:04:46',-1,'2026-05-17 07:04:46'),(1,1,-1,'2026-01',5000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(2,2,-1,'2026-01',3000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(3,3,-1,'2026-01',4000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(4,4,-1,'2026-01',2500.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(5,5,-1,'2026-01',6000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(6,6,-1,'2026-02',5000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(7,7,-1,'2026-02',3500.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(8,8,-1,'2026-02',4500.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(9,9,-1,'2026-02',2000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(10,10,-1,'2026-02',7000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02');
/*!40000 ALTER TABLE `emp_loan` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `emp_sal_adv`
--

DROP TABLE IF EXISTS `emp_sal_adv`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `emp_sal_adv` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `emp_id` bigint NOT NULL,
  `payroll_month` varchar(20) NOT NULL,
  `amount` decimal(15,2) NOT NULL DEFAULT '0.00',
  ...
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_emp_sal_adv` (`emp_id`,`payroll_month`),
  KEY `fk_emp_sal_adv_emp_id` (`emp_id`),
  KEY `fk_emp_sal_adv_created_by` (`created_by`),
  KEY `fk_emp_sal_adv_modified_by` (`modified_by`),
  KEY `idx_emp_sal_adv_month` (`emp_id`,`payroll_month`),
  CONSTRAINT `fk_emp_sal_adv_created_by` FOREIGN KEY (`created_by`) REFERENCES `usr` (`id`),
  CONSTRAINT `fk_emp_sal_adv_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `employee` (`id`),
  CONSTRAINT `fk_emp_sal_adv_modified_by` FOREIGN KEY (`modified_by`) REFERENCES `usr` (`id`),
  CONSTRAINT `chk_emp_sal_adv_processed` CHECK ((`is_processed` in (_utf8mb4'Y',_utf8mb4'N')))
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emp_sal_adv`
--

LOCK TABLES `emp_sal_adv` WRITE;
/*!40000 ALTER TABLE `emp_sal_adv` DISABLE KEYS */;
INSERT INTO `emp_sal_adv` VALUES (-1,-1,'MMYYYY',0.00,'N',NULL,-1,'2026-05-17 07:04:46',-1,'2026-05-17 07:04:46'),(1,1,'2026-01',24999.95,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-06-01 02:13:23'),(2,2,'2026-01',15000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(3,3,'2026-01',30000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(4,4,'2026-01',20000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(5,5,'2026-01',10000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(6,6,'2026-02',18000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(7,7,'2026-02',12000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(8,8,'2026-02',22000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(9,9,'2026-02',8000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(10,10,'2026-02',16000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02');
/*!40000 ALTER TABLE `emp_sal_adv` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `emp_sal_incr`
--
...
CREATE TABLE `emp_sal_incr` (
  ...
  CONSTRAINT `chk_emp_sal_incr_processed` CHECK ((`is_processed` in (_utf8mb4'Y',_utf8mb4'N')))
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `emp_sal_incr`
--

LOCK TABLES `emp_sal_incr` WRITE;
/*!40000 ALTER TABLE `emp_sal_incr` DISABLE KEYS */;
INSERT INTO `emp_sal_incr` VALUES (-1,-1,'MMYYYY',0.00,'N',NULL,-1,'2026-05-17 07:04:46',-1,'2026-05-17 07:04:46'),(1,1,'2026-01',10000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(2,2,'2026-01',8000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(3,3,'2026-01',5000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(4,4,'2026-01',12000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(5,5,'2026-01',6000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(6,6,'2026-02',15000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(7,7,'2026-02',7000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(8,8,'2026-02',9000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(9,9,'2026-02',4000.00,'N',NULL,1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02'),(10,10,'2026-02',11000.00,'Y','2026-05-25 08:23:02',1,'2026-05-24 21:23:02',1,'2026-05-24 21:23:02');
/*!40000 ALTER TABLE `emp_sal_incr` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `emp_va` VALUES (-1,-1,-1,NULL,0.00,'N',NULL,-1,'2026-05-24 03:50:15',-1,'2026-05-24 03:50:15'),(1,1,1,'2026-02',5000.00,'N',NULL,1,'2026-06-02 01:07:15',1,'2026-06-02 01:07:15'),(2,1,2,'2026-02',8000.00,'N',NULL,1,'2026-06-02 01:07:15',1,'2026-06-02 01:07:15'),(3,1,3,'2026-02',3500.00,'N',NULL,1,'2026-06-02 01:07:15',1,'2026-06-02 01:07:15');
...
CREATE TABLE `loan` (
  ...
  `description` varchar(255) NOT NULL,
  `amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `max_amount` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT 'Maximum amount an employee can apply for',
  `max_installments` int NOT NULL DEFAULT '0' COMMENT 'Maximum repayment period in months',
  `min_service_months` int NOT NULL DEFAULT '0' COMMENT 'Minimum months of service required to be eligible',
  `created_by` bigint NOT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_by` bigint NOT NULL,
  `modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `loan` VALUES (-1,'DEFAULT','Default Loan','Y','System Default Loan',0.00,0.00,0,0,-1,'2026-05-17 12:34:46',-1,'2026-05-17 12:34:46');
...
CREATE TABLE `loan_application` (
  ...
  `installments` int NOT NULL DEFAULT '1' COMMENT 'Total number of monthly installments',
  `monthly_installment` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT 'Calculated: principal_amount / installments',
  ...
  `outstanding_balance` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT 'Remaining principal still to be deducted',
  ...
  CONSTRAINT `chk_la_active` CHECK ((`is_active` in (_utf8mb4'Y',_utf8mb4'N'))),
  CONSTRAINT `chk_la_installments` CHECK ((`installments` >= 1)),
  CONSTRAINT `chk_la_principal` CHECK ((`principal_amount` >= 0)),
  CONSTRAINT `chk_la_status` CHECK ((`status` in (_utf8mb4'PENDING',_utf8mb4'APPROVED',_utf8mb4'REJECTED',_utf8mb4'ACTIVE',_utf8mb4'CLOSED')))
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Loan application lifecycle — one row per employee loan request';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `loan_application` VALUES (1,'LNA-2026-00001',1,-1,'2026-01-05',120000.00,24,5000.00,'2026-02','Vehicle loan - Toyota','ACTIVE',1,'2026-01-10 09:00:00',NULL,NULL,NULL,120000.00,'2026-01-10',5,95000.00,NULL,'Y',1,'2026-06-01 17:55:58',1,'2026-06-01 17:55:58'),(2,'LNA-2026-00002',2,-1,'2026-01-08',60000.00,12,5000.00,'2026-02','Personal emergency','ACTIVE',1,'2026-01-12 10:00:00',NULL,NULL,NULL,60000.00,'2026-01-12',5,35000.00,NULL,'Y',1,'2026-06-01 17:55:58',1,'2026-06-01 17:55:58'),(3,'LNA-2026-00003',3,-1,'2026-02-01',240000.00,36,6666.67,'2026-03','Housing renovation','ACTIVE',1,'2026-02-05 09:30:00',NULL,NULL,NULL,240000.00,'2026-02-05',3,220000.07,NULL,'Y',1,'2026-06-01 17:55:58',1,'2026-06-01 17:55:58'),(4,'LNA-2026-00004',4,-1,'2026-02-14',90000.00,18,5000.00,'2026-03','Education fees','PENDING',NULL,NULL,NULL,NULL,NULL,0.00,NULL,0,90000.00,NULL,'Y',1,'2026-06-01 17:55:58',1,'2026-06-01 17:55:58'),(5,'LNA-2026-00005',5,-1,'2026-02-20',150000.00,30,5000.00,'2026-03','Exceeded eligibility limit','REJECTED',1,'2026-02-25 11:00:00',NULL,NULL,NULL,0.00,NULL,0,150000.00,NULL,'Y',1,'2026-06-01 17:55:58',1,'2026-06-01 17:55:58'),(6,'LNA-2026-00006',6,-1,'2026-03-01',48000.00,12,4000.00,'2026-04','Medical expenses','APPROVED',1,'2026-03-05 10:00:00',NULL,NULL,NULL,48000.00,'2026-03-05',0,48000.00,NULL,'Y',1,'2026-06-01 17:55:58',1,'2026-06-01 17:55:58');
...
CREATE TABLE `loan_installment` (
  ...
  `scheduled_amount` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT 'Amount due this installment',
  `paid_amount` decimal(15,2) NOT NULL DEFAULT '0.00' COMMENT 'Actual amount deducted',
  `status` varchar(10) NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING | PAID | PARTIAL | SKIPPED',
  `paid_date` date DEFAULT NULL,
  `emp_loan_id` bigint DEFAULT NULL COMMENT 'FK → emp_loan.id when deducted in payroll',
  ...
  CONSTRAINT `chk_li_installment_no` CHECK ((`installment_no` >= 1)),
  CONSTRAINT `chk_li_status` CHECK ((`status` in (_utf8mb4'PENDING',_utf8mb4'PAID',_utf8mb4'PARTIAL',_utf8mb4'SKIPPED')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Repayment schedule — one row per monthly installment per application';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Salary increment batch/individual header';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salary_increment` VALUES (-1,'DEFAULT','System Default Increment','INDIVIDUAL','MMYYYY','DRAFT','System default',-1,'2025-12-31 18:30:00',-1,'2025-12-31 18:30:00'),(1,'SI001','Annual Increment 2026 - Batch','BATCH','2026-01','EXPORTED','Annual salary revision for all permanent staff effective January 2026',1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(2,'SI002','Mid-Year Increment - John Fernando','INDIVIDUAL','2026-06','APPROVED','Performance-based increment for Q1 2026',1,'2026-05-15 04:30:00',1,'2026-05-20 05:30:00'),(3,'SI003','Mid-Year Increment 2026 - Batch','BATCH','2026-07','DRAFT','Proposed mid-year increment for all branches',1,'2026-05-28 03:00:00',1,'2026-05-28 03:00:00'),(4,'SI004','Probation Completion - Emp 3','INDIVIDUAL','2026-03','CANCELLED','Cancelled — employee resigned before effective date',1,'2026-02-10 03:30:00',1,'2026-02-28 10:30:00'),(5,'Test001','Special increment','BATCH','2026-06','DRAFT','Test',1,'2026-06-02 03:06:46',1,'2026-06-02 03:06:46');
...
DROP TABLE IF EXISTS `salary_increment_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Per-employee salary increment detail';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `salary_increment_detail`
--

LOCK TABLES `salary_increment_detail` WRITE;
/*!40000 ALTER TABLE `salary_increment_detail` DISABLE KEYS */;
INSERT INTO `salary_increment_detail` VALUES (-1,-1,-1,0.00,0.00,0.00,'N',NULL,'System default',-1,'2025-12-31 18:30:00',-1,'2025-12-31 18:30:00'),(1,1,1,85000.00,5000.00,90000.00,'Y','2026-01-20 14:30:00',NULL,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(2,1,2,72000.00,4000.00,76000.00,'Y','2026-01-20 14:30:00',NULL,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(3,1,3,68000.00,3500.00,71500.00,'Y','2026-01-20 14:30:00',NULL,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(4,1,4,95000.00,7500.00,102500.00,'Y','2026-01-20 14:30:00',NULL,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(5,1,5,58000.00,3000.00,61000.00,'Y','2026-01-20 14:30:00',NULL,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(6,2,1,90000.00,10000.00,100000.00,'N',NULL,'Outstanding Q1 performance rating',1,'2026-05-15 04:30:00',1,'2026-05-15 04:30:00'),(7,3,1,90000.00,6000.00,96000.00,'N',NULL,NULL,1,'2026-05-28 03:00:00',1,'2026-05-28 03:00:00'),(8,3,2,76000.00,4500.00,80500.00,'N',NULL,NULL,1,'2026-05-28 03:00:00',1,'2026-05-28 03:00:00'),(9,3,3,71500.00,3500.00,75000.00,'N',NULL,NULL,1,'2026-05-28 03:00:00',1,'2026-05-28 03:00:00'),(10,4,3,68000.00,5000.00,73000.00,'N',NULL,NULL,1,'2026-02-10 03:30:00',1,'2026-02-28 10:30:00');
/*!40000 ALTER TABLE `salary_increment_detail` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `salary_increment_fa`
--

DROP TABLE IF EXISTS `salary_increment_fa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Fixed-allowance increment per employee detail';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `salary_increment_fa`
--

LOCK TABLES `salary_increment_fa` WRITE;
/*!40000 ALTER TABLE `salary_increment_fa` DISABLE KEYS */;
INSERT INTO `salary_increment_fa` VALUES (-1,-1,-1,0.00,0.00,0.00,-1,'2025-12-31 18:30:00',-1,'2025-12-31 18:30:00'),(1,1,1,15000.00,2000.00,17000.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(2,1,2,12000.00,1000.00,13000.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(3,2,1,12000.00,1500.00,13500.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(4,3,2,8000.00,1000.00,9000.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(5,4,1,10000.00,2000.00,12000.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(6,4,3,5000.00,2000.00,7000.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(7,5,4,5000.00,500.00,5500.00,1,'2026-01-10 03:30:00',1,'2026-01-20 09:00:00'),(8,6,1,17000.00,3000.00,20000.00,1,'2026-05-15 04:30:00',1,'2026-05-15 04:30:00'),(9,6,2,13000.00,2000.00,15000.00,1,'2026-05-15 04:30:00',1,'2026-05-15 04:30:00'),(10,6,4,2000.00,500.00,2500.00,1,'2026-05-15 04:30:00',1,'2026-05-15 04:30:00'),(11,7,1,17000.00,2000.00,19000.00,1,'2026-05-28 03:00:00',1,'2026-05-28 03:00:00'),(12,8,1,13500.00,1500.00,15000.00,1,'2026-05-28 03:00:00',1,'2026-05-28 03:00:00');
/*!40000 ALTER TABLE `salary_increment_fa` ENABLE KEYS */;
UNLOCK TABLES;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_emp_bonus_pivot` */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_emp_loan_pivot` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_emp_sal_adv_pivot` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_emp_sal_adv_pivot`(IN p_payroll_month VARCHAR(20))
BEGIN
    DECLARE v_sql LONGTEXT DEFAULT '';
    ...
    SET v_sql = CONCAT(
        'SELECT
            ...
            e.payroll_name,
            e.basic_salary,
            IFNULL(sa.amount, 0)       AS sal_adv_amount,
            ''Salary Advance''         AS sal_adv_label,
            IFNULL(sa.is_processed, ''N'') AS is_processed,
            sa.processed_date
        FROM employee e
        LEFT JOIN emp_sal_adv sa
            ON e.id = sa.emp_id
            AND sa.payroll_month = ''', p_payroll_month, '''
        WHERE e.is_active = ''Y'' AND e.id > 0
        ORDER BY e.id'
    );
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_emp_sal_incr_pivot` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2026-06-02  8:48:32
